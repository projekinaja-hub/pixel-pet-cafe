...
enum Cities {
    /// ECONOMY V2 unlock costs: retuned for the linear benefit curves —
    /// income no longer compounds exponentially per level, so the ladder
    /// grows ~×6–8 per city instead of the old sqrt-era cliff.
    static let all: [CityDef] = [
        CityDef(id: "home",    name: "Home Town",     vibe: "Warm & cozy",         cost: 0,        rateBonus: 1.0,  priceBonus: 1.0),
        CityDef(id: "sakura",  name: "Sakura Town",   vibe: "Cherry blossoms 🌸",  cost: 50_000,   rateBonus: 1.3,  priceBonus: 1.0),
        CityDef(id: "neon",    name: "Neon City",     vibe: "Nightlife & neon 🌙", cost: 400_000,  rateBonus: 1.0,  priceBonus: 1.5),
        CityDef(id: "seaside", name: "Seaside Bay",   vibe: "Salt air & surf 🌊",  cost: 3e6,      rateBonus: 1.45, priceBonus: 1.1),
        CityDef(id: "forest",  name: "Whisperwood",   vibe: "Deep green calm 🌲",  cost: 20e6,     rateBonus: 1.3,  priceBonus: 1.3),
        CityDef(id: "desert",  name: "Oasis Dunes",   vibe: "Golden heat 🏜️",      cost: 120e6,    rateBonus: 1.1,  priceBonus: 1.7),
        CityDef(id: "snowy",   name: "Frostpeak",     vibe: "Cocoa weather ❄️",    cost: 700e6,    rateBonus: 1.6,  priceBonus: 1.25),
        CityDef(id: "sunset",  name: "Amber Harbor",  vibe: "Endless golden hour 🌅", cost: 4e9,   rateBonus: 1.35, priceBonus: 1.6),
        CityDef(id: "ember",   name: "Emberfall",     vibe: "Volcanic springs 🌋", cost: 25e9,     rateBonus: 1.8,  priceBonus: 1.4),
        CityDef(id: "royal",   name: "Crown Court",   vibe: "Royal patronage 👑",  cost: 150e9,    rateBonus: 1.4,  priceBonus: 2.0),
        CityDef(id: "cloud",   name: "Cloudspire",    vibe: "Above the sky ☁️",    cost: 900e9,    rateBonus: 2.0,  priceBonus: 1.7),
        CityDef(id: "moon",    name: "Mare Café",     vibe: "Earthrise views 🌕",  cost: 5e12,     rateBonus: 2.0,  priceBonus: 2.2),
    ]
