...
enum StaffPalette {
    static let defaults: [String: StaffColorPair] = [
        ...
        // Jeki: arctic-white fur and spacesuit (they share the body layer, so
        ...
        "jeki":   StaffColorPair(body: StaffColor(r: 250, g: 250, b: 253), clothes: StaffColor(r: 146, g: 154, b: 168)),
    ]
