...
enum StaffPalette {
    static let defaults: [String: StaffColorPair] = [
        ...
        // Jeki: arctic-white FUR against a separate off-white spacesuit. The
        // two were once the same white, which made him one shapeless blob and
        // meant a tint moved both together; they recolour apart now, and an
        // INK outline keeps a white animal legible on a pale background.
